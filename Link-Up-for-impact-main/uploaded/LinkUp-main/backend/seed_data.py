...
async def seed_missions():
    missions = [
        # Nível 1 - Ansiedade Social Leve (5 missões)
        {
            "id": str(uuid.uuid4()),
        ...
        # Nível 2 - Ansiedade Social Moderada (5 missões)
        {
            "id": str(uuid.uuid4()),
        ...
        # Nível 3 - Ansiedade Social Severa (5 missões)
        {
            "id": str(uuid.uuid4()),
    ...
    print(f"✅ {len(missions)} missões criadas (5 por nível)")
